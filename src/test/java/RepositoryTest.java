...
public class RepositoryTest {
    Ticket ticket1 = new Ticket(1, 200, "GOJ", "LED", 180);
    Ticket ticket2 = new Ticket(2, 400, "KUF", "LED", 160);
    Ticket ticket3 = new Ticket(3, 600, "OGZ", "LED", 120);
    Ticket ticket4 = new Ticket(4, 800, " FRU", "LED", 240);
    Ticket ticket5 = new Ticket(5, 100, "MOW", "LED", 50);
